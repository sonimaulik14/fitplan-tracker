...
export const PHOTO_QUERIES: Record<string, string> = {
  ...
  "page:physique": "physique posing athletic body dark",
  "page:strength": "barbell strength power dark",
  "page:timeline": "gym training calendar plan dark",
